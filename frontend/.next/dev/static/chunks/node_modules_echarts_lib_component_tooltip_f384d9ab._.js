...
function getTooltipTextStyle(textStyle, renderMode) {
    var nameFontColor = textStyle.color || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$echarts$2f$lib$2f$visual$2f$tokens$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].color.tertiary;
    var nameFontSize = textStyle.fontSize || 12;
    var nameFontWeight = textStyle.fontWeight || '400';
    var valueFontColor = textStyle.color || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$echarts$2f$lib$2f$visual$2f$tokens$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].color.secondary;
...
function buildNameValue(ctx, fragment, topMarginForOuterGap, toolTipTextStyle) {
    ...
    var markerStr = noMarker ? '' : ctx.markupStyleCreator.makeTooltipMarker(fragment.markerType, fragment.markerColor || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$echarts$2f$lib$2f$visual$2f$tokens$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].color.secondary, renderMode);
...
var TooltipModel = /** @class */ function(_super) {
    ...
    TooltipModel.defaultOption = {
        ...
        enterable: false,
        backgroundColor: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$echarts$2f$lib$2f$visual$2f$tokens$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].color.neutral00,
        // box shadow
        shadowBlur: 10,
        ...
        borderWidth: 1,
        defaultBorderColor: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$echarts$2f$lib$2f$visual$2f$tokens$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].color.border,
        ...
        axisPointer: {
            ...
            crossStyle: {
                color: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$echarts$2f$lib$2f$visual$2f$tokens$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].color.borderShade,
                width: 1,
                type: 'dashed',
                // TODO formatter
                textStyle: {}
...
function assembleTransition(duration, onlyFadeTransition, enableDisplayTransition) {
    ...
    if (!onlyFadeTransition) {
        ...
        transitionText += (transitionText.length ? ',' : '') + (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zrender$2f$lib$2f$core$2f$env$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].transformSupported ? "" + CSS_TRANSFORM_VENDOR + transitionOption : ",left" + transitionOption + ",top" + transitionOption);
    }
...
var TooltipHTMLContent = /** @class */ function() {
   ...
   */ TooltipHTMLContent.prototype.update = function(tooltipModel) {
    ...
    TooltipHTMLContent.prototype.show = function(tooltipModel, nearPointColor) {
        ...
        if (!el.innerHTML) {
            ...
            style.cssText = gCssText + assembleCssText(tooltipModel, !this._firstShow, this._longHide, this._enableDisplayTransition) + assembleTransform(styleCoord[0], styleCoord[1], true) + ("border-color:" + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$echarts$2f$lib$2f$util$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["convertToColorString"])(nearPointColor) + ";") + (tooltipModel.get('extraCssText') || '') + (";pointer-events:" + (this._enterable ? 'auto' : 'none'));
        }
        this._show = true;
   ...
   */ TooltipHTMLContent.prototype._moveIfResized = function() {
    ...
    TooltipHTMLContent.prototype.dispose = function() {
        ...
        clearTimeout(this._longHideTimeout);
        var zr = this._zr;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zrender$2f$lib$2f$core$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transformLocalCoordClear"])(zr && zr.painter && zr.painter.getViewportRoot(), this._container);
        var el = this.el;
        if (el) {
    ...
    TooltipView.prototype._tryShow = function(e, dispatchAction) {
        ...
        if (dataByCoordSys && dataByCoordSys.length) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$echarts$2f$lib$2f$util$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findEventDispatcher"])(el, function(target) {
                ...
                } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$echarts$2f$lib$2f$util$2f$innerStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getECData"])(target).tooltipConfig != null) {
